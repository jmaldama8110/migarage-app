...
const articulo1 = store.dispatch(addArticulo({ titulo: 'Sierra de mesa', precio: 1500.40 , creadoEl: 1592326800000 }))
const articulo2 = store.dispatch(addArticulo({ titulo: 'Mesa de trabajo', precio: 1400.50 , creadoEl: 1592326800000 }))
const articulo3 = store.dispatch(addArticulo({ titulo: 'Ingletadora', precio: 2800.50 , creadoEl: 1592326800000 }))
...
const articulo9 = store.dispatch(addArticulo({ titulo: 'Cepillo', precio: 230.9 , creadoEl: 1592326800000 }))
const articulo10 = store.dispatch(addArticulo({ titulo: 'Brocas', precio: 180.8 , creadoEl: 1592326800000 }))
